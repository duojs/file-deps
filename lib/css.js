...
/**
 * Add current directory prefix if CSS
 * doesn't have one, add it in when we
 * parse.
 *
 * @param {String} str
 * @return {String}
...
function addCurrentDirPrefix (str) {
  if (str[0] === '/') return str
  else if (str.slice(0, 2) === '..') return str
  else if (str.slice(0, 2) === './') return str
  return './' + str
}
